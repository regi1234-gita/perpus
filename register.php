...
<div class="container">
    <div class="row justify-content-center" style="height: 100vh;">
        <div class="col-md-4">
            <div class="card mt-5">
                <div class="card-body">
                    <h5 class="card-title text-center bg-white">Daftar akun</h5>
                    <?php
                    ...
                    <form method="post">
                        ...
                        <button type="submit" name="register" value="register" class="btn btn-primary w-100 bg-secondary">Daftar</button>
                    </form>
