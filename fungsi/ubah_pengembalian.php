                        ...
                        <form method="post">
                            ...
                            $id = $_GET['id'];
                                if (isset($_POST['submit'])) {
                                    ...
                                    $status_pengembalain = $_POST['status_pengembalian'];
                                    $query = mysqli_query($koneksi, "UPDATE pengembalian SET id_buku='$id_buku', tanggal_pengembalian='$tanggal_pengembalian', status_pengembalian='$status_pengembalian' WHERE id_pengembalian=$id");
                                ...
                                $query = mysqli_query($koneksi, "SELECT*FROM pengembalian WHERE id_pengembalian=$id");
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <select name="status_pengembalian" class="form-control">
                                        ...
                                        <option value="dikembalikan" <?php if($data['status_pengembalian'] == ['dikembalikan']) echo 'selected'; ?>>Dikembalikan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
